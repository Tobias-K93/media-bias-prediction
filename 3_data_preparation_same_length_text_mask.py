...
with open("contents_ids_source_removed.csv", newline='') as f:
    reader = csv.reader(f)
...
torch.save(contents_text_tensor,'contents_text_tensor_source_removed.pt')
torch.save(contents_mask_tensor,'contents_mask_tensor_source_removed.pt')
